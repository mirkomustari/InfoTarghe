...
public class TFLiteObjectDetectionAPIModel implements Detector {
  ...
  /**  nome file contenente le labels. */
  private static String labelsFileName;


  /** lista di labels delle immagini. */
  ...
  private TFLiteObjectDetectionAPIModel(Context context, String modelFilename) throws IOException {
    try {
      associatedAxisLabels = FileUtil.loadLabels(context, labelsFileName);
    } catch (IOException e) {
